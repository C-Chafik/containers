...
/*   Updated: 2022/08/08 20:46:20 by cmarouf          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft
{
    ...
    class map
    {
        public:
            ...
            typedef typename    ft::RBT<T, Compare>::iterator iterator;
            typedef typename    ft::RBT<T, Compare>::const_iterator const_iterator;
